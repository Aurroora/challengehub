...
urlpatterns = [
    ...
    path('my-challenges/<int:challenge_id>/calendar/', views.challenge_calendar, name='challenge_calendar'),
    
    path('my-challenges/<int:challenge_id>/stats/', views.challenge_statistics, name='challenge_stats'),
